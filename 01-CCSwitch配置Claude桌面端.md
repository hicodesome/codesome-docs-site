...
![ccswitch macOS 安装包](<images/CC Switch 配置 Claude 桌面端教程-ccswitch-macos-download.png>)

![ccswitch Windows 安装包](<images/CC Switch 配置 Claude 桌面端教程-ccswitch-windows-download.png>)

macOS 首次打开如果遇到安全提示，需要在系统设置里允许打开当前开发者。

![macOS 允许打开 cc-switch](<images/CC Switch 配置 Claude 桌面端教程-ccswitch-macos-security.png>)
...
![](<images/CC Switch 配置 Claude 桌面端教程-ccswitch右上角图标.png>)
...
![](<images/CC Switch 配置 Claude 桌面端教程-ccswitch详细配置之v3配置.png>)
...
![](<images/CC Switch 配置 Claude 桌面端教程-ccswitch详细配置之二合一.png>)
...
![](<images/CC Switch 配置 Claude 桌面端教程-ddac61b0-0a8a-4685-aef1-05bf9662c660.png>)
...
* Claude Cowork 安装指南：https://support.claude.com/en/articles/13345190-get-started-with-claude-cowork

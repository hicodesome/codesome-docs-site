...
**新人必领：**[cc兑换码兑换指南（codesome 新人体验额度领取入口）](05-兑换码兑换指南.md)

## 欢迎来到codeosme，下面是新手村必看（最底部可进新手群）

> **使用前先看：[分组是什么、怎么选、怎么切换？](02-分组是什么怎么选怎么切换.md)**
>
> 不确定分组选什么、倍率怎么算或怎么切换，先看这篇。
...
[【配置优化】Claude Code 上下文自动压缩配置](02-ClaudeCode上下文压缩配置.md)

AI 编程课学习（从小白到可以拿融资的独立开发者）

[全网最值得看的熠辉老师 AI 编程课](05-AI编程课红包福利.md)

[【小白课程】Codesome claude code 小白课程录播](04-小白课程录播合集.md)

AI agent 自主学习👇（搞钱必备技能树）

[一个专门为全栈工程师设计的结构化 Agent 学习平台](03-Agentway学习平台介绍.md)



## 购买前重要提示与 V3/V4 站点说明

> **先确认你买的是哪一种扣桑服务。**&#x56;3、V4、二合一入口和使用方式不同，兑换码、卡密、API Key 也不是同一个东西。

> 用前了解，扣桑没有免费的服务，请了解价格后下单。
>
> **<span style="color: rgb(216,57,49); background-color: inherit">注释：经过我们渠道优化，月卡和按量付费目前均保持线路稳定，故大家可以根据自己喜好进行选择购买，不需要考虑稳定性问题，如果稳定性出现持续性不可用，我们会进行广播通知以及进行相关处置。</span>**
>
...
1. 购买的话：访问 meta.codesome.cn 购买下单拿兑换码；访问 cc.codesome.ai 来使用；（兑换码在兑换区兑换）
...
| ------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| **老站点**<br /> | **按量充值** | 当前新充值统一走 V3；使用入口为 `v3.codesome.cn` （cc.codesome.ai）                                                                                                | 在 `meta.codesome.cn` 购买后拿到的是兑换码。先到 V3 兑换区充值余额，再到后台创建 API Key。兑换码用于充值，API Key 用于连接服务，多个兑换码要逐个兑换。 |
|               | **按月付费** | 月卡只适用于月卡分组。                                                                                                                                        | 月卡不能使用按量分组；如果需要按量分组，请购买或充值对应的按量余额。                                                            |
| **新站点**       | **二合一**  | 使用入口为 `https://v5.codesome.cn`（aio.codesome.ai）<br />⚠️<span style="color: rgb(216,57,49); background-color: inherit">开头key 是 cr_开头要在这个站点使用</span> | 二合一同样在 meta.codesome.cn 购买。二合一获得的卡密就是 API Key，无需再兑换；不要拿二合一卡密去 V3 主站兑换。                          |

...
| 你的情况                         | 应该看                                                                                       |
| ---------------------------- | ----------------------------------------------------------------------------------------- |
| 使用 V3 配 Codex，key 是 `sk-...` | [V3 Codex 安装与配置指南](https://zvgmnl1sw58.feishu.cn/wiki/O13Yw8j1kiseS4k2TC0c2Qp8nug)        |
| 使用 V3 配 Claude Code          | [V3 Claude Code 安装与配置指南](https://zvgmnl1sw58.feishu.cn/wiki/IPomwd31niucKwkVIVucP63an1g)  |
| 使用二合一配 Claude Code           | [二合一 Claude Code 安装与配置指南](https://oxv18tgb72z.feishu.cn/docx/GRTgdoyi9olkeLxv6TBcpc47nPg) |

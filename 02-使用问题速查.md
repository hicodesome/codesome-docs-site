...
## 9. Opus 5 更新后，月卡分组如何配置 Opus 5

如果你想在月卡分组使用 Opus 5，推荐使用 ccswitch 的模型映射。

打开 ccswitch 的配置，下拉找到“高级选项 / 模型映射”，按字段填写：

| 字段             | 填写                          |
| -------------- | --------------------------- |
| 主模型            | `claude-sonnet-5`         |
| 推理模型（Thinking） | `claude-opus-5`           |
| Haiku 默认模型     | `claude-haiku-4-5-20251001` |
| Sonnet 默认模型    | `claude-sonnet-5`         |
| Opus 默认模型      | `claude-opus-5`           |

ccswitch 的模型映射位置如下图所示。

![Opus 5 模型映射配置](<images/codesome｜使用问题速查-opus-46-model-mapping.png?v=5c49a465656c6d6d6c049140062230d6f2671d7debf32188c34241f5c60c976d>)
...
![Windows 清理 Claude Code 旧版本路径示例](<images/codesome｜使用问题速查-windows-rollback-command-paths.png?v=79ece3485d4a9a92976079c5e7cd813f8813800f6c80fc7b4da42004c3289a3b>)

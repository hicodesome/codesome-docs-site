...
![503 分组状态示例](<images/codesome｜使用问题速查-codesome-503-status.png?v=dc385e9a80a2ef118228fd466dbcab054f04c207fc5f5af9e3efe7e2b27eda5e>)
...
## 9. Opus 4.7 更新后，月卡分组如何继续使用 Opus 4.6

如果 Opus 4.7 更新后你仍想在月卡分组继续使用 Opus 4.6，推荐使用 ccswitch 的模型映射。
...
![Opus 4.6 模型映射配置](<images/codesome｜使用问题速查-opus-46-model-mapping.png?v=5c49a465656c6d6d6c049140062230d6f2671d7debf32188c34241f5c60c976d>)

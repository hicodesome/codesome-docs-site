...
(function (root) {
  ...
  "01-二合一计划-Hermes配置-Mac手动版.md": "【最新】Hermes 客户端配置教程（V3 / V5）",
  ...
  "03-GPTImage2终端生图备忘录.md": "GPT Image 2 终端生图备忘录",
  ...
  root.CODESOME_ARTICLE_TITLES_VERSION = "title-map-98f71c8a90f7a323";
}(window));
